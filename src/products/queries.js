...
const addProduct =
  "INSERT INTO products (product_name, product_description, price, stock_quantity) VALUES ($1, $2, $3, $4)";
...
const updateProductStockQuantity =
  "UPDATE products SET stock_quantity = $1 WHERE product_id = $2"; // $1 - 1st variable we passed in, $2 2nd variable we passed in
